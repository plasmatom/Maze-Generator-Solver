...
class mainPanel(QWidget):
    def __init__(self):
        ...
        self.maze = Maze(60, 0.7, self.width/self.height)
...
class mainWindow(QMainWindow):
    def __init__(self):
        ...
        action_1.setIconText('depth_first Search'.title())
        tool_bar.addSeparator()
        ...
        action_2.setIconText('bredth_first Search'.title())
        tool_bar.addSeparator()
        ...
        action_3.setIconText('Gready best-first search'.title())
        tool_bar.addSeparator()
